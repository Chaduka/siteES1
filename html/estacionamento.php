            ...
            <div class="box-body">
              <form role="form">
                ...
                <div class="form-group">
                  ...
                  <input type="number" min="0" class="form-control" id="pisos">
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="checkbox">
                    <label>
                      <input type="checkbox">Categoria A
                    </label>
                  </div>
                  <div class="checkbox">
                    <label>
                      <input type="checkbox">Categoria B
                    </label>
                  </div>
                  <div class="checkbox">
                    <label>
                      <input type="checkbox">Categoria C
                    </label>
                  </div>
                  <div class="checkbox">
                    <label>
                      <input type="checkbox">Categoria D
                    </label>
                  </div>
                  <div class="checkbox">
                    <label>
                      <input type="checkbox">Categoria E
                    </label>
                  </div>
                </div>
